      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`tel:${contactInfo.phoneRaw}`} className="hover:text-primary transition-colors">
                  {contactInfo.phone}
                </a>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <span className="text-xs text-gray-500">Política de Privacidad</span>
            <span className="text-xs text-gray-500">Términos y Condiciones</span>
          </div>
        </div>
      </div>
    </footer>
