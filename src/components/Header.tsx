    ...
    <>
      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <button
            type="button"
            className="md:hidden rounded-md p-2.5 text-gray-700 min-w-11 min-h-11 flex items-center justify-center cursor-pointer"
      ...
      {/* Mobile menu - outside header to avoid transform containing block */}
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
